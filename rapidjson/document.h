...
public:
    ...
    */
    ...
    //!@name Handling parse_folder errors
    //!@{
    ...
    //! Implicit conversion to get the last parse_folder result
#ifndef __clang // -Wdocumentation
    /*! \return \ref ParseResult of the last parse_folder operation

        \code
          Document doc;
          ParseResult ok = doc.Parse(json);
          if (!ok)
            printf( "JSON parse_folder error: %s (%u)\n", GetParseError_En(ok.Code()), ok.Offset());
        \endcode
     */
#endif
